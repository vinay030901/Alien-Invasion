...
class AlienInvasion:
    ...
    def run_game(self):
        ...
        while True:
            ...
            # Game events that should run only when the game is active
    ...
    def _check_alien_bullet_collisions(self):
        ...
        # If so, get the rid of the bullet and the alien.
    ...
    def _check_play_button(self, mousepos):
        ...
        button_clicked = self.play_button.rect.collidepoint(mousepos)
